            ...
            <div className="mt-6 space-y-3">
              {!data?.jobs || data.jobs.length === 0 ? (
                <EmptyState
                  ...
                  message="We're currently connecting your career graph to available live market opportunities."
                  icon={
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="mt-6 space-y-3">
              {!data?.skillGaps || data.skillGaps.length === 0 ? (
                <EmptyState
                  ...
                  message="Add projects to your graph to reveal potential tech stack gaps."
                  icon={
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                data.skillGaps.map((skill) => (
                  ...
                  >
                    ...
                    <span className="rounded-md bg-white px-2 py-0.5 text-[11px] font-medium text-slate-500 border border-slate-200/60 shadow-xs">
                      {skill.jobCount} job
                      {skill.jobCount !== 1 ? "s" : ""}
                    </span>
                  </motion.div>
...
function EmptyState({ title, message, icon, accentColor = "indigo" }) {
